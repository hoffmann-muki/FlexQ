...
class QuantOPTAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = QuantLinear(
            ...
            # test_weight_quant_params,
            # test_act_quant_params
        )
...
class QuantOPTDecoderLayer(nn.Module):
    def __init__(
        ...
        self.self_attn_layer_norm = FlexQLayerNorm(
        ...
        self.final_layer_norm = FlexQLayerNorm(
    ...
    def forward(
        ...
        **kwargs
        ...
        if output_attentions:
            self_attn_weights = torch.mean(self_attn_weights, dim=0)
