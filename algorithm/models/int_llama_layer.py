...
from algorithm.flexq_quantize.flexq_norm import FlexQLlamaRMSNorm
...
class QuantLlamaMLP(nn.Module):
    def __init__(
        ...
        self.down_proj = QuantLinear(org_module.down_proj,
                                           args.weight_quant_params,
                                           args.act_down_proj_quant_params if args.flex_linear_quant else args.act_quant_params)
...
class QuantLlamaAttention(nn.Module):
    ...
    def forward(
        ...
        # Replace to execute in forword
        # # abq-llm activation quant_ debug
...
class QuantLlamaDecoderLayer(nn.Module):
    def __init__(self, 
        ...
        self.input_layernorm = FlexQLlamaRMSNorm(ori_layer.input_layernorm,eps=ori_layer.input_layernorm.variance_epsilon)
        self.post_attention_layernorm = FlexQLlamaRMSNorm(ori_layer.post_attention_layernorm,eps=ori_layer.post_attention_layernorm.variance_epsilon)
        # self.attn = None
    def forward(
        self,
        hidden_states: torch.Tensor,
