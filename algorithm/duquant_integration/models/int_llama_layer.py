...
from algorithm.duquant_integration.quantize.int_matmul import QuantMatMul
import torch.nn.functional as F
from algorithm.duquant_integration.quantize.du_norm import DuLlamaRMSNorm
...
import pdb
import copy
from algorithm.duquant_integration.models.transformation import *
...
class QuantLlamaAttention(nn.Module):
    ...
    def __init__(self, 
        ...
        self.qkt_matmul = QuantMatMul(
            args.q_quant_params, args.k_quant_params, matmul_func=torch.matmul, rotate=args.q_quant_params.get('rotate', True)
        )
        self.pv_matmul = QuantMatMul(
            args.p_quant_params, args.v_quant_params, matmul_func=torch.matmul, rotate=args.p_quant_params.get('rotate', True)
        )
