...
def main():
    ...
    # init quantization methods 
    if args.symmetric:
        args.disable_zero_point = True

    # init quantization granularity
    if args.w_group_size is not None:
        args.w_dynamic_method = "per_group"
    if args.a_group_size is not None:
        args.a_dynamic_method = "per_group"
    ...
    args.act_quant_params = {
        "n_bits":  args.abits if args.flex_linear_quant is False else 6,
        "per_channel_axes": [],
        "symmetric": False,
        "dynamic_method": args.a_dynamic_method,
    }
    args.act_down_proj_quant_params = {
        "n_bits":  args.abits if args.flex_linear_quant is False else 8,
        "per_channel_axes": [],
        "symmetric": False,
        "dynamic_method": args.a_dynamic_method,
    }
    ...
    if args.wbits != 16 or args.abits != 16:
        ...
        logger.info("quantization spend time: %fs" % (time.time() - tick))
