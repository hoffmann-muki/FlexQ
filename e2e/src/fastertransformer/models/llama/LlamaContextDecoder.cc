        ...
        invokeGeneralLayerNorm(decoder_normed_packed_input_,
           ...
           self_attention_input_tensors.insertIfValid("d_prefix_prompt_lengths",
            ...
            if(int8_mode_ == 5){
                ...
                // self_attention_input_tensors.insert("input_query", Tensor{MEMORY_GPU, activation_in_type, {hidden_units_ / 128, (size_t)(h_token_num * decoder_input_x_bits * 4)}, decoder_normed_packed_input_});
                self_attention_input_tensors.insert("input_query", Tensor{MEMORY_GPU, activation_in_type, {h_token_num, (size_t)(hidden_units_ / 128 * decoder_input_x_bits * 4)}, decoder_normed_packed_input_});
                ...
                self_attention_input_tensors.insert("input_query", Tensor{MEMORY_GPU, activation_in_type, {h_token_num, (size_t)hidden_units_}, decoder_normed_input_});
            }
...
//               exit(0);
               ...
               TensorMap ffn_input_tensors(
                ...
                if(int8_mode_ == 5){
                    // For adaptation, keep `h_token_num` as input_query.shape[0]
                    // ffn_input_tensors.insert("ffn_input", Tensor{MEMORY_GPU, data_type, {hidden_units_ / 128, (size_t)(h_token_num * attn_output_x_bits * 4)}, normed_packed_self_attn_output_});
                    ffn_input_tensors.insert("ffn_input", Tensor{MEMORY_GPU, data_type, {h_token_num, (size_t)(hidden_units_ / 128 * attn_output_x_bits * 4)}, normed_packed_self_attn_output_});
                }else{
                    ffn_input_tensors.insert("ffn_input", Tensor{MEMORY_GPU, data_type, {h_token_num, (size_t)hidden_units_}, decoder_normed_input_});
                }
