...
private:
   ...
   // (FlexQ) The bit width of the input activations to the attention layer in the LLaMA model.
   const int decoder_input_x_bits = 6;  
   // (FlexQ) The bit width of the input activations to the FFN layer in the LLaMA model.
   const int attn_output_x_bits = 6;  
...
protected:
   int* decoder_normed_packed_input_  = nullptr;
   T*      decoder_normed_input_   = nullptr;
   T*      self_attn_output_       = nullptr;
   int* normed_packed_self_attn_output_  = nullptr;
   ...
   half* decoder_normed_input_s6scale_ = nullptr;
   half* out_input_s6scale_ = nullptr;
   half* ffn_normed_input_s6scale_ = nullptr;
   half* down_input_s8scale_ = nullptr;
