                                    ...
                                    const std::vector<ParallelGptDecoderLayerWeight<T>*>* gpt_decoder_layer_weight)
{
    ...
    for (uint l = 0; l < num_layer_; l++) {
        ...
        if(int8_mode_ == 5){
            ...
            //     "input_query", Tensor{MEMORY_GPU, activation_in_type, {hidden_units_ / 128, local_batch_size * decoder_input_x_bits * 4}, decoder_normed_packed_input_});
            self_attention_input_tensors.insert(
                "input_query", Tensor{MEMORY_GPU, activation_in_type, {local_batch_size, hidden_units_ / 128 * decoder_input_x_bits * 4}, decoder_normed_packed_input_});
            self_attention_input_tensors.insert(
            ...
            self_attention_input_tensors.insert(
                "input_query", Tensor{MEMORY_GPU, activation_in_type, {local_batch_size, hidden_units_}, layernorm_type_ == LayerNormType::pre_layernorm ? decoder_normed_input_ : decoder_input});
        }
        ...
        TensorMap ffn_input_tensors(
        {
            // {"ffn_input", Tensor{MEMORY_GPU, activation_in_type, {local_batch_size, hidden_units_}, layernorm_type_ == LayerNormType::pre_layernorm ? normed_self_attn_output_ : after_adapter_attn_output_}},
        ...
        if(int8_mode_ == 5){
            // For adaptation, keep `local_batch_size` as input_query.shape[0]
            // ffn_input_tensors.insert("ffn_input", Tensor{MEMORY_GPU, activation_in_type, {hidden_units_ / 128, local_batch_size * attn_output_x_bits * 4}, normed_packed_self_attn_output_});
            ffn_input_tensors.insert("ffn_input", Tensor{MEMORY_GPU, activation_in_type, {local_batch_size, hidden_units_ / 128 * attn_output_x_bits * 4}, normed_packed_self_attn_output_});
        }else{
            ffn_input_tensors.insert("ffn_input", Tensor{MEMORY_GPU, activation_in_type, {local_batch_size, hidden_units_}, layernorm_type_ == LayerNormType::pre_layernorm ? normed_self_attn_output_ : after_adapter_attn_output_});
        }
