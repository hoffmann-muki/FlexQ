...
private:
    ...
    // (FlexQ) The bit width of the input activations to the attention layer in the OPT model.
    const int decoder_input_x_bits = 6;
    // (FlexQ) The bit width of the input activations to the FFN layer in the OPT model.
    ...
    half* down_input_s6scale_ = nullptr;
