...
template<typename T>
class LlamaV2ContextAttentionLayer: public BaseAttentionLayer<T> {
private:
    // buffer handling
...
public:
    LlamaV2ContextAttentionLayer(size_t           max_batch_size,
                                 size_t           max_seq_len,
                                 size_t           head_num,
                                 size_t           kv_head_num,
    ...
    LlamaV2ContextAttentionLayer(LlamaV2ContextAttentionLayer<T> const& attention_layer);

    virtual ~LlamaV2ContextAttentionLayer();
